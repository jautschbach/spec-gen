#!/usr/bin/env python3
""" spec-gen.py -- A simple spectral convolution program for IR, ECD, VCD, CPL, MCDA and MCDB
Usage:
    spec-gen.py [options]
...
try:
    ...
    arguments = docopt(__doc__, version='spec-gen.py version 0.0.3')
